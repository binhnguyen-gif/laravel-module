    ...
    <div class="row">
        <div class="col-12">
            <div class="action mb-3 d-flex justify-content-end">
                <a class="btn btn-primary" href="{{ route('blog.admin.category.create') }}"> Add</a>
            </div>
        </div>
        <div class="col-12">
            <div class="card">
                    ...
                    <table  class="table m-0">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td class="text-right">
                                    <a class="btn btn-soft-primary btn-sm" href="{{ route('blog.admin.category.edit', $item->id) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <x-form-delete :item="$item" url="{{ route('blog.admin.category.destroy', $item->id) }}"></x-form-delete>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
