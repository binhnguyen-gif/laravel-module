    ...
    <div class="row">
        <div class="col-12">
            <div class="action mb-3 d-flex justify-content-end">
                <a class="btn btn-primary" href="{{ route('core.admin.page.create') }}"> Add</a>
            </div>
        </div>
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mt-0 mb-1">Pages</h4>
                    <p class="sub-header">
                    </p>
                    ...
                    <table  class="table m-0">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td>{{ $item->page_layout }}</td>
                                <td>
                                    <x-form-is-publish :item="$item" name="is_published" />
                                </td>
                                <td>{{ $item->created_at }}</td>
                                <td class="text-right">
                                    <a class="btn btn-soft-primary btn-sm" href="{{ route('core.admin.page.edit', $item->id) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <x-form-delete :item="$item" url="{{ route('core.admin.page.destroy', $item->id) }}"></x-form-delete>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
