...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function generate($item, $type = 'articles')
        {
                        /** @var \Modules\Core\Services\SeoDataService $instance */
                        return $instance->generate($item, $type);
        }
     ...
     */ 
         ...
         * @return \Modules\Menu\Services\MenuRegisterService 
         * @throws \Illuminate\Contracts\Container\BindingResolutionException
         * @static 
         */ 
        public static function register($menuName, $builderId, $model, $mapping = [])
        {
                        /** @var \Modules\Menu\Services\MenuRegisterService $instance */
                        return $instance->register($menuName, $builderId, $model, $mapping);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function renderMenuItem($menuId = null)
        {
                        /** @var \Modules\Menu\Services\MenuRegisterService $instance */
                        return $instance->renderMenuItem($menuId);
        }
                    /**
         * Render Fontend menu.
         *
         ...
         * @static 
         */ 
        public static function render($key, $view)
        {
                        /** @var \Modules\Menu\Services\MenuRegisterService $instance */
                        return $instance->render($key, $view);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function add($name, $key, $view)
        {
                        /** @var \Modules\Page\Services\PageLayoutService $instance */
                        return $instance->add($name, $key, $view);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function findView($key)
        {
                        /** @var \Modules\Page\Services\PageLayoutService $instance */
                        return $instance->findView($key);
        }
...
namespace  { 
            ...
            class SeoData extends \Modules\Core\Facades\SeoData {}
            class MenuBuilder extends \Modules\Menu\Facades\MenuBuilder {}
            class PageLayout extends \Modules\Page\Facades\PageLayout {}
